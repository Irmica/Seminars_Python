...
# Онлайн-магистратура в НИУ ВШЭ — Machine Learning. Успей!
# Программа готовит ML инженеров, способных провести полный цикл разработки. Узнай!
# studyonline.hse.ru 
# реклама
# Курсы для сотрудников компаний
# Образовательная платформа Stepik для онлайн- обучения сотрудников компаний

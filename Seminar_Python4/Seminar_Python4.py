...
#         break
#     if string_input[i] == "a":
#         print(f"a_{count_a}", end = ' ')
#         count_a += 1
#     if string_input[i] == "b":
#         print(f"b_{count_b}", end = ' ')
#         count_b += 1  
#     if string_input[i] == "c":
#         print(f"c_{count_c}", end = ' ')
#         count_c += 1
#     if string_input[i] == "d":
#         print(f"d_{count_d}", end = ' ')
#         count_d += 1
...
# array_of_string = input_string.split()
...
# input_number = int(input("Введите натуралное число: "))
# sequence = []
...
# sequence = [0]*(3*input_number+2)

# for i in range(input_number+1):
#     sequence[i*3+1] = i*3+1
# print(sequence)
